...
function WhatSection() {
  return (
    <Article
      header="What"
      first="UNIFY Music is a  webapp for learning to play Piano."
    >
      <p>
        UNIFY Music is great for beginners – you can play songs without needing to learn sheet music.
        UNIFY Music creates an intuitive <span className="italic">Falling Notes</span> visualization
        of a song.
      </p>
      <Sizer height={8} />
      <CaptionedImage
      ...
      <Sizer height={24} />
      <p>
        For those who want to learn sheet music, UNIFY Music offers{' '}
        ...
        mode. UNIFY Music will by default display a song in it’s original key, but you may change the
...
function GettingStarted() {
  return (
    <Article header="Getting started" first="Plug in a keyboard. Start slow. Gradually speed up.">
      ...
      <p>
        UNIFY Music works best in conjunction with a Piano teacher. Falling notes will allow you to
...
function MusicSelectionSection() {
  return (
    <Article
      ...
      first="The UNIFY Music catalog has three components: midishare, builtin, and local file uploads."
    >
      <p>
        UNIFY Music includes works from <AboutLink href="https://midishare.com">midishare</AboutLink>,
      ...
      <p>
        ...
        local, you can also upload them directly to UNIFY Music which saves them in browser storage.
      </p>
      <p>
        If you can’t find the music you’re looking for on midishare, a Google search is your best
        bet. Or you can send us an{' '}
        <AboutLink href="info@webtiga.com">email</AboutLink> and I’ll try to help out.
      </p>
    </Article>
  )
}
...
function BrowserCompatibilitySection() {
  return (
    <Article
      ...
      first="UNIFY Music is fully compatible with the latest versions of Chrome and Firefox."
    >
      <p>
  ...
  return (
    <Article header="Roadmap">
      ...
      <ul className="px-12 list-disc">
        ...
        <li>MP3/MP4 file upload and full Sheet Music display.</li>
        ...
        <li>GPT Implementation as a virtual Music teacher, Real time conversation with GPT.</li>
        <li>Full End-to-End Music Generation.</li>
      </ul>
    </Article>
  )
}
...
function FeedbackSection() {
  return (
    <Article header="Feedback">
      <p>
        Found a bug or have a feature request? Please dont hesitate to{' '}
        <AboutLink href="sales@webtiga.com">Get in touch</AboutLink> or send
        an <AboutLink href="info@webtiga.com">email</AboutLink>.
      </p>
    </Article>
  )
}
